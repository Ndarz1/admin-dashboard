          ...
          >
            <div className="group">
              ...
              <input
                ...
                type="email"
                className="w-full border-b border-gray-300 py-3 text-lg text-gray-900 focus:outline-none focus:border-ruby-red-600 transition-colors placeholder:text-gray-200"
            ...
            <div className="flex justify-between items-center text-xs">
              <label className="flex items-center gap-2 cursor-pointer text-gray-500 hover:text-gray-900">
                <input type="checkbox" className="accent-ruby-red-600" />
                <span>Remember me</span>
              </label>
              <a
                href="#"
                className="text-ruby-red-600 hover:text-gray-900 transition-colors border-b border-transparent hover:border-gray-900 pb-0.5"
              >
                Forgot Password?
              </a>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="mt-4 bg-gray-900 text-white py-4 text-xs uppercase tracking-[0.25em] hover:bg-ruby-red-600 transition-all duration-500 shadow-lg disabled:opacity-70 disabled:cursor-not-allowed flex justify-center items-center gap-3"
            >
              {isLoading ? (
                <>
                  <svg
